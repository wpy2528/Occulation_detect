...
parser.add_argument('data', nargs='?', metavar='DIR', const=None,
                    ...
                    default='/data/DATA/Mower_labeled_data/Occlusion_data/occulation_datasets/wpy/occulation_inference/outside',
...
parser.add_argument('--output_dir', metavar='DIR',
                    default='/data/DATA/Mower_labeled_data/Occlusion_data/occulation_datasets/wpy/occulation_data/inference_output/20250417-222324-resnet18-224',
                    help='path to output files')
parser.add_argument('--checkpoint',
                    default='output/train/Occu_detect/20250613-145540-resnet18-224/checkpoint-3.pth.tar',
...
parser.add_argument('--RFB', default=False, type=bool, help='Using Receptive Field Block for network')
