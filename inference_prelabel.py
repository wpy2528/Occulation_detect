...
parser.add_argument('data', nargs='?', metavar='DIR', const=None,
                    default='/data/DATA/Mower_labeled_data/Occlusion_data/occulotion_datasets/occulotion_0827/images',
...
parser.add_argument('--output_dir', metavar='DIR',
                    default='/data/DATA/Mower_labeled_data/Occlusion_data/occulotion_datasets/occulotion_0827/inference',
                    help='path to output files')
parser.add_argument('-s', '--score', default=0.6, type=float,
                    metavar='N', help='conf source')
parser.add_argument('--save_result2img', metavar='DIR', default=True,
                    help='save result to img')
parser.add_argument('--save_dir', metavar='DIR', default='./',
                    help='path to output files')
...
parser.add_argument('--checkpoint',
                    default='/home/wangpengyuan/OcculsionProject/pytorch-image-models-main/output/train/best/20240812-151900-resnet18-224/model_best.pth.tar',
...
def main():
    ...
    for index, row in df.iterrows():
        ...
        if conf > args.score:
            ...
            save_path = os.path.join(args.output_dir, pre_cls)
            os.makedirs(save_path, exist_ok=True)
            print("img: {} pre: {} score: {:.3f}".format(img_name, pre_cls, conf))
            shutil.copy(img_file, os.path.join(save_path, img_name))
