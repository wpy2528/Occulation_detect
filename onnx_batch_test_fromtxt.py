...
onnx_path = "/home/zzf/pytorch-image-model-20231023/pytorch-image-models-main/20240307-112323-dark-mv2.onnx"
img_dir = "/media/wpy/558e3a8b-7a8f-4603-a6fb-20c87dbd584b/zhangzhaofeng/bright_dark_1130/new_dark_train/train_data/dark_val_dataset"
...
dest_txt_path = "/media/wpy/558e3a8b-7a8f-4603-a6fb-20c87dbd584b/zhangzhaofeng/bright_dark_1130/new_dark_train/train_data/val/ori_image_file-dest.txt"
...
ori_img_names = []
f = open(ori_txt_path, "r")
ori_img_names = f.readlines()
f.close()


output_lines = []

for image_name_line in ori_img_names:
    image_name = image_name_line.strip("\n").split(" ")[0]
    label_str = image_name_line.strip("\n").split(" ")[1]
    ...
    pres = list(output[0])
    pres = [str(s) for s in pres]
    line = image_name + " " + " ".join(pres) + " " + label_str + "\n"
    output_lines.append(line)
    # print(output)

f = open(dest_txt_path, "w")
