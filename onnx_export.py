...
parser.add_argument('--checkpoint', default='output/train/20250417-222205-resnet18-128/model_best.pth.tar', type=str,
                    metavar='PATH',
...
group.add_argument('--GSconv', default=0, type=int, help='Using groupwise conv for network if using DWconv.-1:groups=auto, 1:Not use, >1:=groups')
...
parser.add_argument('--verbose', default=True, action='store_true',
                    help='Extra stdout output')  # 开启 verbose 模式，可以查看是否有任何不支持的算子


def main():
    args = parser.parse_args()
    args.output = "output/onnx/20250417-222205-resnet18-128.onnx"
