...
# parser.add_argument('data', metavar='DIR',default="/media/wpy/558e3a8b-7a8f-4603-a6fb-20c87dbd584b/zhangzhaofeng/bright_dark_1130/dark_dataset/train_data",
#                     help='path to dataset')
parser.add_argument('--data',
                    default="/home/wangpengyuan/OcculsionProject/occlusion_data/occulotion_datasets/occulotion_0614/train_data",
                    help='path to dataset')
parser.add_argument('--onnx-input',
                    default='output/onnx/20240718-204415-occu-mv2.onnx',
                    type=str, metavar='PATH',
                    help='path to onnx model/weights file')
parser.add_argument('--onnx-output-opt',
                    default='/home/zzf/pytorch-image-model-20231023/pytorch-image-models-main/regney_004_dark_detect_opt.onnx',
                    type=str, metavar='PATH',
...
def main():
    ...
    args.gpu_id = 0
    # args.data = "/media/wpy/558e3a8b-7a8f-4603-a6fb-20c87dbd584b/zhangzhaofeng/bright_dark_1130/dark_dataset/train_data"
